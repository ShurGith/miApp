...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-theme="{{ Session::get('themeLocal') }}">
    ...
    @endphp
        ...
        <link rel="stylesheet" href="{{ asset('css/pagedone.css') }}">
        <!-- Scripts -->
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen">
            ...
            <!-- Page Heading -->
                <header class="shadow">
                    <div class="flex items-center gap-2 px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
                      <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        - <span class="flex items-center gap-2"><svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script src="{{ asset('js/pagedone.js') }}"></script>
</body>
</html>
